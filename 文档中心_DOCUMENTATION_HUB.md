...
- **生成日期**：`2026-07-12`
- **最近增补**：`2026-07-18`（v0.11.0「万枢」：新增收录 `docs/万枢平台-架构设计.md`）；`2026-07-19` 按工作树现状同步正文快照；`2026-09-09` 回填源提交 `cc7345e` 并按该提交的 Git blob 重算 SHA-256
...
> **版本状态**：本合集冻结于 v0.11.0「万枢」（2026-07-18）时点。**项目现行发布版本为 v1.0.0（2026-09-05 正式发布），已超出本合集快照范围**——合集内 v0.11.0 及更早版本号均来自各来源文档的历史快照原文，为保真收录、不作改写；现行事实以根目录 CHANGELOG.md 与 `backend/app/version.py` 的 `VERSION_HISTORY` 为准。
...
- **SHA-256**：`b15950e62f6d51c31e3f9931f9763ced66c691a9a0a72bb258e4389d3fbfde19`
- **源提交**：`cc7345eb5d5f66d2e3098180bb2097ce29a075ee`（快照正文与该提交的 `docs/万枢平台-架构设计.md` 逐字节一致；v0.11.0 发布提交为 `5d47bdb`，本条目快照取自其后 `2026-07-19` 的 `cc7345e`）
